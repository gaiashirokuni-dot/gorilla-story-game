...
【V1.7】
・タイトルをKUNIO / STORYのロゴ構成に変更
・タイトル副題「今日は、俺に任せる？」をロゴ下へ整理
・会話送りアイコンをADV風の点＋シェブロン演出へ変更
・通常会話は画面（会話エリア）タップでタイプ中の文章を全文表示
・リアクション画面は文章表示後、会話エリアのタップでも次へ進行可能
・ボタン操作は従来通り残してアクセシビリティを維持
・選択肢の出現演出を段階的なフェード＋スライドへ改善
・prefers-reduced-motion対応を維持
